 ...
 * @author hoffmann
 */
@ManagedBean(name = "FichaCadastralEventoMB")
@ViewScoped
public class FichaCadastralEventoMB extends BasicControl{
    ...
    public void initEvento() {
        try {
            ...
            evento = eventoService.findEventoLocalizacaoCerimonia(idEvento);
    ...
    public synchronized String save() {
        try {
            ...
            return "/intranet/admin/operacional/pre-evento/partials/ficha-cadastral.xhtml?idEvento=" + idEvento + "&faces-redirect=true";
        } catch (Exception ex) {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, null, ex);
