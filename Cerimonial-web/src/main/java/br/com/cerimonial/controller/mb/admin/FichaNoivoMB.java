 ...
 * @author hoffmann
 */
@ManagedBean(name = "FichaNoivoMB")
@ViewScoped
public class FichaNoivoMB extends BasicControl {
    ...
    public synchronized String save() {
        try {
            ...
            if (validate.isValid()) {
                ...
                return "/intranet/admin/operacional/pre-evento/partials/cadastro-casamento.xhtml?idEvento=" + idEvento + "&tipoEnvolvido=" + tipoEnvolvido + "&faces-redirect=true";
            } else {
