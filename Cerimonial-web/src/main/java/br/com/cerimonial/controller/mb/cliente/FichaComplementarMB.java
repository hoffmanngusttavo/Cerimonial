 ...
 * @author hoffmann
 */
@ManagedBean(name = "FichaComplementarMB")
@ViewScoped
public class FichaComplementarMB extends ClienteControl{
    ...
    public synchronized String save() {
        try {
            ...
            return "/intranet/cliente/evento/partials/ficha-complementar-casal.xhtml?idEvento=" + idEvento + "&faces-redirect=true";
        } catch (Exception ex) {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, null, ex);
